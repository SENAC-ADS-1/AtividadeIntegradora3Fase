...
import view.cadastros.cadastroFuncionarios;
...
public class listaFuncionarios extends javax.swing.JDialog {
    ...
    private final daoFuncionario dao = new daoFuncionario();
    
    private void carregarTabela(String nome) throws SQLException {
        tbDados.setModel(new MyTableModel(Funcionario.class, dao.read(nome), tbDados));
    }
    ...
    private void abreCadastro(Funcionario funcionario) {
        new cadastroFuncionarios(
                null, 
                true,
                funcionario == null ? null : funcionario
        ).setVisible(true);
    }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        try {
            ...
            Funcionario funcionario = dao.read(codigo);

            abreCadastro(funcionario);
